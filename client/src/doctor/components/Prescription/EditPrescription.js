...
//   const [selectData, setSelectData] = useState(editData && editData.patientDetail[0].name);

//   console.log('selectData',selectData);

   //setSelectData({ ...selectData, editData });

//   console.log("edit_data1", editData);
  //console.log('setData',selectData);
                          ...
                          <div className="form-row">
                            <div className="form-group col-md-12 m-0">
                              <div className="form-group m-0">
                                ...
                                <input
                                  type="hidden"
                                  value={selectPatient.patientId}
                                  name="patientId"
                                />
                                <input
                                  type="hidden"
                                  value={appId !== undefined ? appId : selectPatient.appointmentId}
                                  name="appointmentId"
                                />
                              </div>
                            </div>
